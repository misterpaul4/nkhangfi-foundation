const FAQs = [
  {
    question: "how do i participate in the Nkhangfi Scholarship Program?",
    answer: "you can do so by filling the form or simply contacting us via email(info@nkhangfifoundation.com). Make sure you meet the requirements before you apply."
  },
  {
    question: "How can I join the Y.Ö.S exam?",
    answer: "The first step is to check the requirements, after that you can apply directly from our website or simply send an email to info@nkhangfifoundation.com indicating your interest in participating in the exam. Please note that it is subject to availability."
  },
  {
    question: "What study programs can be studied with the YÖS exam?",
    answer: "The list of courses that can be studied with the YÖS exam are available on request.",
  },
  {
    question: "Who has the right to apply for the YÖS exam",
  ...
  {
    question: "When is the deadline to register? for YÖS 2021",
    answer: "May 1st, 2021"
  },
  {
    question: "What is the application fee for the YÖS program",
    answer: "$200 USD",
  },
  {
    question: "What is the application fee for the nkhangfi scholarship program 2021",
    answer: "$50 USD",
  },
  {
    question: "Can i take the YÖS exam online?",
