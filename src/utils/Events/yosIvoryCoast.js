import img1 from '../../images/events/yos_ivory1.png';
...
import mainImg from '../../images/events/yos_ivorycoast.jpg';
...
const Event = {
  ...
  pathName: 'yos_ivory_coast',
  bg: 'nk-events-exam',
  name: 'yös exam',
  theme: 'yös exam, ivory coast',
  parent: 'events',
  image: mainImg,
  title: 'Yös exam was conducted in Ivory Coast',
