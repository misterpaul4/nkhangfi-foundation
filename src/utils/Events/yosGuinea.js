import img1 from '../../images/events/yos_guinea1.jpg';
import img2 from '../../images/events/yos_guinea2.jpg';
import img3 from '../../images/events/yos_guinea3.jpg';
// import { nspApplicationUrl } from '../Forms';
import { Link } from 'react-router-dom';
import '../../css/utils.css';
import mainImg from '../../images/events/yos_guinea.png';
import Events from '../events';

// const isFirefox = typeof InstallTrigger !== 'undefined';

const AttachEvents = (ev, index) =>{
  if(index < 7 && ev.link !== 'yos_guinea') {
    return (
