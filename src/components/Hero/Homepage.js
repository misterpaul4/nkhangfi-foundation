...
import '../../css/hero.css';
import nsp from '../../utils/Events/nsp';
import yos from '../../utils/Events/yos';
      ...
      <div className="container">
        <div className="row no-gutters slider-text align-items-center">
            ...
            <div className="text mt-5 pt-5 container hp-hero-content" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
              ...
              <p>- Neche</p>
          		<p>
                <Link to={{pathname: "/event/nsp", event: nsp}} className="btn btn-primary p-4 py-3 m-1">scholarship program (NSP)<span className="fas fa-long-arrow-alt-right"></span></Link>
                <Link to={{pathname: "/event/yos", event: yos}} className="btn btn-white p-4 py-3 m-1">Y.Ö.S Turkey <span className="fas fa-long-arrow-alt-right"></span></Link>
              </p>
            </div>
        	</div>
        </div>
