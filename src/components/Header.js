          ...
          <div className="col-md d-flex justify-content-end align-items-center">
            <div className="social-media">
              <p className="mb-0 d-flex">
                ...
                <Link to={{pathname: "mailto: info@nkhangfifoundation.com"}} target="_blank" rel="noopener noreferrer" className="d-flex align-items-center justify-content-center"><span className="fa fa-envelope"><i className="sr-only">Email</i></span></Link>
              </p>
            </div>
          </div>
